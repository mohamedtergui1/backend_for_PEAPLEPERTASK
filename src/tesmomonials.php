...
<body class="overflow-x-hidden dark:bg-gray-900 ">
    ...
    <body class="overflow-x-hidden dark:bg-gray-900 ">
                            ...
                            <div class="flex   gap-4">
                                <form method="GET" >
                                    <input id="value_add_cetegory" name="comment"
                                        ...
                                        <select class="border-2 shadow h-10 w-40   rounded-md p-1  border-2 dark:text-black"  name="user" required >
        ...
        <div class="flex flex-col border bg-slate-100 dark:text-black dark:bg-slate-700  ">
          <ul class="flex justify-around bg-slate-50 bg-slate-800 dark:text-white py-3">
