<?php 
   ...
   if(isset($_SESSION['role'])&&isset($_SESSION['id_user'])){
        ...
        $name_user=$username;
        $status="log-out";
        $username_link="./freelancer_profile.php";
...
<header class="flex bg-gray-50 justify-between p-2 md:py-3 md:px-8 lg:px-10 dark:bg-slate-800">
      ...
      <div class="carousal h-72">
        <ul class="h-full flex flex-row gap-3 text-gray-50 overflow-hidden">
          ...
          <li
            ...
            <img class="absolute w-full h-full" src="../images/categories/<?=$category_image?>" alt="">
            <div class="absolute w-full h-full p-5">
              <a href="www.google.com?id=<?=$category_id?>" class="h-fit">
                <p class="text-md ">click here to see more</p>
  ...
  <section id="freelancers" class="freelancers-section w-full p-4 md:py-3 md:px-8 lg:px-10">
   ...
   <li
            ...
            <a href="./freelancer_profile.php?id=<?=$freelancer_id?>">
            <div class="px-3 py-1 bg-green-50 dark:bg-gray-700 h-72 flex flex-col justify-between">
              
              <div class="w-full mb-3">
                <img class="photo rounded-full w-7/12 m-auto" src="../images/users/<?=$freelancer_image?>" alt="freelancerPhoto">
              ...
              <div class="flex flex-row justify-start gap-2">
                <img class="country-flag w-6 h-6 rounded-full" src="../images/moroccoFlag.png" alt="countryFlag">
                <h4 class="country text-gray-500 dark:text-gray-50  font-normal"><?=$city_freela . " " . $region_freela ?> Morroco </h4>
              </div>
...
?>
  ...
  <section id="offers" class="offers-section bg-white dark:bg-slate-800 w-full p-4 md:py-3 md:px-8 lg:px-10">
    <div class="flex flex-col gap-y-4">
      <div class="flex flex-row justify-between w-full mb-3 items-end font-medium">
        <div class="w-1/2">
          <h2 class="text-xl dark:text-gray-300 md:text-2xl lg:text-3xl font-semibold">Trending projectss</h2>
...
<li
            ...
            <div class="bg-gray-50 dark:bg-zinc-700 w-full min-h-56 flex flex-col justify-between p-2 rounded-md">
              <div class="flex flex-row p-3 items-center gap-0.5">
                <h3 class="title text-gray-700 dark:text-slate-200 font-semibold text-lg"><?=$project_name?></h3>
              </div>
              <div class="flex flex-col gap-y-3">
                ...
                <div class="flex flex-row justify-between text-gray-600 dark:text-slate-200 items-center px-3">
                  <div class="flex flex-row gap-x-2 items-center">
                    <img class="freelancer-photo w-10 h-10 rounded-full" src="../images/users/<?=$user_image?>" alt="offers Freelancer photo">
                    <div class="flex flex-col">
                      <p>by <strong class="freelancer-name font-semibold"><?=$project_user?></strong></p>
