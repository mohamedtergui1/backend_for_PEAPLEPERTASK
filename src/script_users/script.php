...
// if(isset($_POST["fname"])&&isset($_POST["lname"])&&isset($_POST["password"])&&isset($_POST["email"])&&isset($_POST["region"])&&isset($_POST["city"])){
//     $email = $_POST["email"];
//     $fname=$_POST["fname"];
//     $lname=$_POST["lname"];
...
//         echo "please enter valide firstname";
//     } 
//     else if(preg_match('/[A-Za-z\s]/',$lname)){
//         echo "please enter valide lastname";
//     }
//     else if(strlen($password)<7){
//         echo "you enter a week password";
//     }
//     else if(!filter_var($email,FILTER_VALIDATE_EMAIL)){
//         echo "this is not format email";
//     }
//     else if(mysqli_num_rows($result)>0 ){
//         echo "this email is allready exist !!";
//     }
//     else{
//         echo "1";
//     }
