    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
        ...
        <div>
            <div class="w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
                ...
                <form class="mt-8 space-y-6" action="projects_management.php" method="post">
                    ...
                    <?php endwhile; ?>
                        ...
                        <option selected value="<?=$categoriesID?>"><?php 
                            $subcategory_name=mysqli_fetch_assoc(mysqli_query($cnx,"SELECT name FROM categories where id=$categoriesID"))["name"];
                            echo $name;
                        ?></option>
