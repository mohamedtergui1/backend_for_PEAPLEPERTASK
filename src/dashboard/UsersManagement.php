...
<body class="overflow-x-hidden  dark:bg-gray-900 dark:text-white">
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col "
                                                    ...
                                                    <form
                                                        ...
                                                        method="get" action="script/script_user.php">
    ...
    <dialog id="add_user" class="w-3/4 h-5/6 dark:bg-gray-800">
     ...
     <div class="flex justify-center" >
            <form method="POST" action="script/script_user.php" class="h-auto w-auto flex-grow flex flex-col gap-6 align-middle p-6 "  enctype="multipart/form-data" >
