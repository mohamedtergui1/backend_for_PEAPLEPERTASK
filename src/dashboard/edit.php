    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
        ...
        <div>
            <div class="w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
                ...
                <form class="mt-8 space-y-6" action="script/script_user.php" method="post">
                    ...
                    <label for="remember" class="font-medium text-gray-500 dark:text-gray-400">region</label>
                        ...
                        <select name="region" class=" dark:text-black w-2/3 h-10" id="" required>
            ...
            ?>
             ...
             <?php endwhile; ?>
                        ...
                        <select name="city" class=" dark:text-black w-2/3 h-10" id="" required>
