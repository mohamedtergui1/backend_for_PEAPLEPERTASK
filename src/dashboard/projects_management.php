...
<body class="overflow-x-hidden  dark:bg-gray-900 dark:text-white">
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col "
                                                    ...
                                                    <form
                                                        ...
                                                        method="get"
                                                        action="script/script_project.php">
                                                ...
                                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                    ...
                                                    <td class="py-4 px-6 text-sm font-medium text-right whitespace-nowrap ">
                                                        <form
                                                            ...
                                                            action="script/script_project.php" method="get"
    ...
    <dialog id="add_project" class="w-3/4 h-5/6 dark:bg-gray-800">
        ...
        <div class="flex justify-center">
            <form method="POST" action="script/script_project.php" class="h-auto w-auto flex-grow flex flex-col gap-6 align-middle p-6 " enctype="multipart/form-data">
